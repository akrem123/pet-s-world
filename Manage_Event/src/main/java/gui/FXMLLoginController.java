    ...
    ////////////////////////////////////////////////////////////////    
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() { 
            ...
            if (ms.logintest(email.getText(),mdp.getText())){    
                ...
                if(Glabal.type.equalsIgnoreCase("vet"))
                
                {
                try {
                    
                    btn.getScene().setRoot(FXMLLoader.load(getClass().getResource("../fxml/Login.fxml")));
                } catch (IOException ex) {
                    ...
                    btn.getScene().setRoot(FXMLLoader.load(getClass().getResource("../GUI/FXMLEspaceAdmin.fxml")));
                } catch (IOException ex) {
                    Logger.getLogger(FXMLLoginController.class.getName()).log(Level.SEVERE, null, ex);
                }
                }
