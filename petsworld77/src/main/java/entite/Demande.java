...
public class Demande {
    ...
    public Demande(int numero, String dateann, String type, String description) {
        this.numero = numero;
        this.dateann = dateann;
        this.type = type;
        this.description = description;
    ...
    public Demande(int numero, String dateann, String type, String description, String imagee) {
        this.numero = numero;
        this.dateann = dateann;
        this.type = type;
        this.description = description;
    ...
    public Demande(String dateann, String type, String description, String imagee) {
        this.dateann = dateann;
        this.type = type;
        this.description = description;
        this.imagee = imagee;
